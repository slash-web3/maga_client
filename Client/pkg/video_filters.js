...
*/
export function apply_red_filter(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.apply_red_filter(ptr0, len0);
}

/**
* @param {string} canvas_id
*/
export function apply_yellow_filter(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.apply_yellow_filter(ptr0, len0);
}

/**
* @param {string} canvas_id
*/
export function apply_green_filter(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.apply_green_filter(ptr0, len0);
}

/**
* @param {string} canvas_id
*/
export function apply_blue_filter(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.apply_blue_filter(ptr0, len0);
}

/**
* @param {string} canvas_id
*/
export function apply_blur_filter(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.apply_blur_filter(ptr0, len0);
}

/**
* @param {string} data_url
*/
export function save_canvas_snapshot(data_url) {
    const ptr0 = passStringToWasm0(data_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.save_canvas_snapshot(ptr0, len0);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('video_filters_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
